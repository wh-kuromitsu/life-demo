// サンプル児童30名（完全架空データ）
// 実在の児童・家族・施設関係者とは一切関係ありません。
// 全ての名前はカタカナの造語で、実在しない仮想の人物です。
// 実運用パターンを織り込むためのデモデータ:
// - 高校連携（通信制高校）
// - 祖父母宅送迎
// - 時間指定児童（古い契約の残存）
// - 同乗NGペア
...
export const CHILDREN = [
  // ─── 放デイ PLUS (小学校中心) ───
  {
    id: 'c01', name: 'ミナト レン', kana: 'ミナト レン', gender: '男', age: 9, grade: '小3',
    ...
    guardian: { name: 'ミナト アヤ', rel: '母', tel: '090-1234-5678' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c02', name: 'アオリ ハナ', kana: 'アオリ ハナ', gender: '女', age: 7, grade: '小2',
    ...
    guardian: { name: 'アオリ タケル', rel: '父', tel: '090-2345-6789' },
    ngWith: [], priority: 2, status: 'active',
  },
  {
    id: 'c03', name: 'ホシノ アサ', kana: 'ホシノ アサ', gender: '男', age: 8, grade: '小3',
    ...
    guardian: { name: 'ホシノ ナオ', rel: '母', tel: '090-7890-1234' },
    ngWith: [], priority: 3, status: 'active',
  },

  // ─── 児発 PALETTE (未就学) ───
  {
    id: 'c04', name: 'シオリ サラ', kana: 'シオリ サラ', gender: '女', age: 5, grade: '年長',
    ...
    guardian: { name: 'シオリ ユミ', rel: '母', tel: '090-4567-8901' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c05', name: 'カナン ユナ', kana: 'カナン ユナ', gender: '女', age: 5, grade: '年長',
    facility: 'palette', school: null, pickupLoc: 'home',
    ...
    guardian: { name: 'カナン ヨウコ', rel: '母', tel: '090-8901-2345' },
    ngWith: [], priority: 2, status: 'active',
  },

  // ─── 放デイ LABO ───
  {
    id: 'c06', name: 'リンド ユウ', kana: 'リンド ユウ', gender: '男', age: 12, grade: '小6',
    ...
    guardian: { name: 'リンド ケン', rel: '父', tel: '090-3456-7890' },
    ngWith: ['c07'], priority: 3, status: 'active',
  },
  {
    id: 'c07', name: 'セキネ ナオ', kana: 'セキネ ナオ', gender: '男', age: 11, grade: '小6',
    facility: 'labo', school: 'toubu', pickupLoc: 'school',
    ...
    guardian: { name: 'セキネ アイ', rel: '母', tel: '090-1002-3004' },
  ...
  // ─── 放デイ NOBA (中学生・高校生) ───
  {
    id: 'c08', name: 'フウカ ソラ', kana: 'フウカ ソラ', gender: '男', age: 14, grade: '中2',
    ...
    guardian: { name: 'フウカ アキ', rel: '父', tel: '090-5678-9012' },
    ngWith: [], priority: 2, status: 'active',
  },
  {
    id: 'c09', name: 'ヤヒロ ユコ', kana: 'ヤヒロ ユコ', gender: '女', age: 16, grade: '高1',
    ...
    guardian: { name: 'ヤヒロ トモ', rel: '母', tel: '090-2211-3344' },
    ngWith: [], priority: 3, status: 'active',
    tag: '翔陽連携',
  },
  {
    id: 'c10', name: 'シズノ ハル', kana: 'シズノ ハル', gender: '男', age: 17, grade: '高2',
    facility: 'noba', school: 'shoyo', pickupLoc: 'school',
    ...
    guardian: { name: 'シズノ サチ', rel: '母', tel: '090-3322-4455' },
    ngWith: [], priority: 3, status: 'active',
    tag: '翔陽連携',
  },
  ...
  // ─── 放デイ PROGRESS ───
  {
    id: 'c11', name: 'トワ ヒマリ', kana: 'トワ ヒマリ', gender: '女', age: 10, grade: '小4',
    ...
    guardian: { name: 'トワ チヨ', rel: '母', tel: '090-6789-0123' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c12', name: 'ハナイ ハルカ', kana: 'ハナイ ハルカ', gender: '女', age: 9, grade: '小4',
    ...
    guardian: { name: 'ハナイ ショウ', rel: '父', tel: '090-8877-6655' },
    ngWith: [], priority: 3, status: 'active',
  },

  // ─── 放デイ MARCHE ───
  {
    id: 'c13', name: 'アマネ ワタル', kana: 'アマネ ワタル', gender: '男', age: 13, grade: '中1',
    ...
    guardian: { name: 'アマネ ミホ', rel: '母', tel: '090-4411-5522' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c14', name: 'モリオ ユタ', kana: 'モリオ ユタ', gender: '男', age: 11, grade: '小5',
    ...
    guardian: { name: 'モリオ リエ', rel: '母', tel: '090-5533-7744' },
    ngWith: [], priority: 3, status: 'active',
    tag: '学童経由',
  },
  ...
  // ─── 放デイ LOHASPO ───
  {
    id: 'c15', name: 'アシロ メイ', kana: 'アシロ メイ', gender: '女', age: 8, grade: '小3',
    ...
    guardian: { name: 'アシロ ミワ', rel: '母', tel: '090-9988-7766' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c16', name: 'ライカ ミズ', kana: 'ライカ ミズ', gender: '女', age: 12, grade: '小6',
    ...
    guardian: { name: 'ライカ ユウ', rel: '祖母', tel: '090-1122-3344' },
    ngWith: [], priority: 3, status: 'active',
    tag: '祖父母宅送迎',
  },
  ...
  // ─── 放デイ MIRAIKU ───
  {
    id: 'c17', name: 'オトハ ヒロ', kana: 'オトハ ヒロ', gender: '男', age: 10, grade: '小4',
    ...
    guardian: { name: 'オトハ タカシ', rel: '父', tel: '090-6699-8877' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c18', name: 'カワイ ダイ', kana: 'カワイ ダイ', gender: '男', age: 13, grade: '中1',
    ...
    guardian: { name: 'カワイ サチ', rel: '母', tel: '090-7755-8844' },
    ngWith: [], priority: 3, status: 'active',
  },

  // ─── 放デイ NOBAサポ ───
  {
    id: 'c19', name: 'フユミ ミツ', kana: 'フユミ ミツ', gender: '女', age: 11, grade: '小5',
    ...
    guardian: { name: 'フユミ ヒデ', rel: '母', tel: '090-5544-3322' },
    ngWith: [], priority: 3, status: 'active',
  },

  // ─── 児発 ふたば ───
  {
    id: 'c20', name: 'マイナ アイリ', kana: 'マイナ アイリ', gender: '女', age: 4, grade: '年中',
    ...
    guardian: { name: 'マイナ ヤス', rel: '母', tel: '090-8822-9911' },
    ngWith: [], priority: 3, status: 'active',
  },

  // ─── 児発 にじのわ ───
  {
    id: 'c21', name: 'キリノ アオ', kana: 'キリノ アオ', gender: '男', age: 5, grade: '年長',
    ...
    guardian: { name: 'キリノ ノゾミ', rel: '母', tel: '090-4433-2211' },
    ngWith: [], priority: 3, status: 'active',
  },

  // ─── 放デイ COMMON ───
  {
    id: 'c22', name: 'ナルミ アオイ', kana: 'ナルミ アオイ', gender: '女', age: 9, grade: '小3',
    ...
    guardian: { name: 'ナルミ クミ', rel: '母', tel: '090-3311-4455' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c23', name: 'マツリ コウ', kana: 'マツリ コウ', gender: '男', age: 15, grade: '中3',
    ...
    guardian: { name: 'マツリ マリ', rel: '母', tel: '090-2244-3355' },
    ngWith: [], priority: 2, status: 'active',
    tag: '時間指定',
  },
  ...
  // ─── 就労 NEO ───
  {
    id: 'c24', name: 'タニオ ハヤ', kana: 'タニオ ハヤ', gender: '男', age: 18, grade: '高3',
    ...
    guardian: { name: 'タニオ ケイ', rel: '父', tel: '090-1155-2266' },
    ngWith: [], priority: 3, status: 'active',
    tag: '翔陽連携',
  },
  ...
  // ─── イレギュラー（特例時間変動） ───
  {
    id: 'c25', name: 'トミヤ ケン', kana: 'トミヤ ケン', gender: '男', age: 12, grade: '小6',
    ...
    certExpiry: '2026-09-30',
    guardian: { name: 'トミヤ サト', rel: '母', tel: '090-9911-8822' },
  ...
  // ─── 追加(多拠点・通院パターン等) ───
  {
    id: 'c26', name: 'タナオ マナ', kana: 'タナオ マナ', gender: '女', age: 10, grade: '小5',
    ...
    guardian: { name: 'タナオ シン', rel: '父', tel: '090-8844-1133' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c27', name: 'ウジタ シュン', kana: 'ウジタ シュン', gender: '男', age: 11, grade: '小5',
    ...
    guardian: { name: 'ウジタ メグミ', rel: '母', tel: '090-7733-2244' },
    ngWith: [], priority: 3, status: 'active',
  },
  {
    id: 'c28', name: 'ヨシナ チヒロ', kana: 'ヨシナ チヒロ', gender: '女', age: 13, grade: '中1',
    ...
    guardian: { name: 'ヨシナ ノリ', rel: '母', tel: '090-6622-1155' },
    ngWith: [], priority: 3, status: 'active',
    tag: '学童経由',
  },
  {
    id: 'c29', name: 'サカリ ヒビキ', kana: 'サカリ ヒビキ', gender: '男', age: 7, grade: '小1',
    ...
    guardian: { name: 'サカリ マイ', rel: '母', tel: '090-5566-4433' },
    ngWith: [], priority: 2, status: 'active',
  },
  {
    id: 'c30', name: 'アサギ ユイ', kana: 'アサギ ユイ', gender: '女', age: 16, grade: '高1',
    ...
    guardian: { name: 'アサギ ユキ', rel: '母', tel: '090-3366-7788' },
    ngWith: [], priority: 3, status: 'active',
    tag: '翔陽連携',
  },
]
